...
do
    ...
    BorderColor3 = FromRGB(0, 34, 37),
    Size = not IsMobile and UDim2New(0, 800, 0, 542) or UDim2New(0, 650, 0, 480),  -- Changed widths
    BorderSizePixel = 2,
    Visible = false,
    BackgroundColor3 = FromRGB(17, 21, 27),
})
				...
				Items["MainFrame"]:MakeResizeable(Vector2New(500, 542), Vector2New(9999, 9999))
